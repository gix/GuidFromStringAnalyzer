namespace TestHelper
{
    ...
    {
        /// <summary>
        ///   Apply the inputted CodeAction to the inputted document. Meant to
        ///   be used to apply codefixes.
        /// </summary>
        ...
        /// <summary>
        ///   Compare two collections of Diagnostics,and return a list of any
        ///   new diagnostics that appear only in the second collection. Note:
        ///   Considers Diagnostics to be the same if they have the same Ids. In
        ///   the case of multiple diagnostics with the same Id in a row, this
