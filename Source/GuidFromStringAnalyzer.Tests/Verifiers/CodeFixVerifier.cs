namespace TestHelper
{
    ...
    {
        /// <summary>
        ///   Returns the codefix being tested (C#) - to be implemented in non-abstract
        ///   class
        /// </summary>
        ...
        /// <summary>
        ///   Returns the codefix being tested (VB) - to be implemented in non-abstract
        ///   class
        /// </summary>
        ...
        ///   string, then gets diagnostics on it and applies the relevant codefixes.
        ///   Then gets the string after the codefix is applied and compares it
        ///   with the expected result. Note: If any codefix causes new diagnostics
        ///   to show up, the test fails unless allowNewCompilerDiagnostics is
        ///   set to true.
        /// </summary>
        ...
        ///   The codefix to be applied to the code wherever the relevant Diagnostic
        ///   is found
        /// </param>
        /// <param name="oldSource">
        ///   A class in the form of a string before the CodeFix was applied to
        ...
        private void VerifyFix(
            string language, DiagnosticAnalyzer analyzer, CodeFixProvider codeFixProvider,
